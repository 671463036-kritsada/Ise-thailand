  ...
  return (
    <div className="p-6 bg-[var(--color-surface)] min-h-screen font-sans antialiased text-[var(--color-deep-text)]">
      ...
      <div className="flex justify-between items-center mb-6 gap-4">
        <div>
          <h1 className="text-3xl font-bold text-[var(--color-forest-blue)] tracking-tight">จัดการภาคส่วน</h1>
              ...
              {loading ? (
                ...
                currentItems.map((row, idx) => (
                  <tr key={row.sector_id}
                    ...
                    <td className="px-5 py-3.5 font-bold text-[var(--color-blue)] text-center font-mono">{row.sector_id}</td>
